                ...
                <v-col xl="3" lg="3" md="3" sm="12" cols="12">
                    ...
                    >
                        <v-autocomplete
                            ...
                            @keydown="filter"
                            no-data-text="خودرو مورد نظر را جستجو کنید."
                        ></v-autocomplete>
                    </BaseAutoComplete>
                </v-col>
                <v-col class="search" xl="3" lg="3" md="3" sm="12" cols="12">
                    <v-btn xl="3" lg="3" md="3" sm="12" cols="12"
...
export default {
    ...
    mounted() {
        const date1 = new Date(this.filters.begin_date);
        const date2 = new Date(this.filters.end_date);
